...
func init() {
	...
	flag.StringVar(&group, "group", "kafka-for-dev", "Kafka consumer group definition")
	flag.StringVar(&version, "version", "3.1.0", "Kafka cluster version")
	flag.StringVar(&topics, "topics", "kafka-pf", "Kafka topics to be consumed, as a comma separated list")
